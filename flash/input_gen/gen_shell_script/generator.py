...
"""
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        defaults = {
            ...
            "flash_home": "$HOME/FLASH/FLASH4.8",
    ...
    def generate_windows_script(self, par_file: Optional[str] = None) -> str:
        ...
        lines = [
            ...
            f"set FLASH_HOME=~/FLASH/FLASH4.8",
            f"set PAR_FILE={par}",
    ...
    def generate_wsl_script(self, par_file: Optional[str] = None) -> str:
        ...
        lines = [
            ...
            '# 非交互 shell 不加载 .bashrc 的 FLASH env 块; 自编译 MPI/HDF5/HYPRE',
            '# 位于 /usr/local/... 不在默认 PATH, 这里显式导出 (目录存在才导出;',
            '# 缺失时静默跳过, 由系统 PATH 兜底, 兼容 apt openmpi 等跨设备环境)。',
