"""
layer_tracer_CH 超算端绘图分析脚本 (独立运行, 无 flash 包依赖)
═══════════════════════════════════════════════════════════════
...
用法 (超算端):
  ...
  python layer_tracer_CH_remote_analysis.py --outdir <outputfiles目录> \
...
def main():
    ap = argparse.ArgumentParser(description="layer_tracer_CH 远端绘图分析")
