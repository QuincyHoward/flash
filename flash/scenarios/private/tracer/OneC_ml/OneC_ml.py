"""
OneC_ml 场景 — 1D 多薄层单一纯材料 (碳 C) 示踪靶烧蚀仿真
═══════════════════════════════════════════════════════════════════
...
用法:
  cd <flash 包目录>
  python -m flash.scenarios.private.tracer.OneC_ml.OneC_ml   # 默认 tmax=1.0e-11
  python flash/scenarios/private/tracer/OneC_ml/OneC_ml.py --tmax 1.6e-9
"""
...
SCENE_NAME = "OneC_ml"  # 场景名 → SIM_NAME/par 文件名/图题/SLURM 作业名
