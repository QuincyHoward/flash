...
SI/AL 两个变体的非 py 输入文件唯一事实来源; gen_flash_inputs.py 读取本模块
写出 sim_input_si/ 或 sim_input_al/。文本内容统一 LF 存储; 写出时
run_flash.bat 恢复 CRLF, 其余保持 LF。cn4: Z 系列从包内中央表库复制,
imx 系列从 tables_imx.py (base64) 解码。
"""
