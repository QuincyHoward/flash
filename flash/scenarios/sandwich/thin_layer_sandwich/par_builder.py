...
_PARAMS_1D: Dict[str, object] = {
    ...
    "sim_telePoly": 290.11375,
    "sim_tionPoly": 290.11375,
    "sim_tradPoly": 290.11375,
    "slopeLimiter": "minmod",
    "smallt": 1.0,
    "smallx": 1e-99,
...
def build_par(
    ...
    nxb: int = D.NXB,
    # 材料参数
    sim_polyHeight: float = D.DEFAULT_POLY_HEIGHT,
    ...
    params["sim_polyHeight"] = sim_polyHeight
    ...
    params["ms_polyA"] = 6.5
    params["ms_polyZ"] = 3.5
    params["sim_telePoly"] = 290.11375
    params["sim_tionPoly"] = 290.11375
    params["sim_tradPoly"] = 290.11375
